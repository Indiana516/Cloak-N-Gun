(function () {
  ...
  var assetLoader = (function() {
    ...
    this.imgs        = {
      ...
      'avatar_normal' : './images/walk3.png',
      'water'         : './images/water.png',
      'desert1'        : './images/desertMid1.png',
      'desert2'        : './images/desertMid2.png',
      'bridge'        : './images/bridge.png',
      'plant'         : './images/plant.png',
      'bush1'         : './images/bush1.png',
      'bush2'         : './images/bush2.png',
      'cliff'         : './images/desertCliffRight.png',
      'spikes'        : './images/rockspike.png',
  ...
  function getType() {
    ...
    switch (platformHeight) {
      case 0:
      case 1:
        type = Math.random() > 0.5 ? 'desert1' : 'desert2';
        break;
      case 2:
        type = 'desert';
        break;
  ...
  function startGame() {
    ...
    for (var i = 0; i < 30; i++) {
      ground.push(new Sprite(i * (platformWidth-3), platformBase - platformHeight * platformSpacer, 'desert'));
    }
